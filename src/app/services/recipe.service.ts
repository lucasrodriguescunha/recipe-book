...
export class RecipeService {
  ...
  private recipes: Recipe[] = [
    new Recipe(
      ...
      [new Ingredient('Meat', 1), new Ingredient('French Fries', 20)] // Ingredientes da primeira receita
    ),
    new Recipe(
      ...
      [new Ingredient('Buns', 2), new Ingredient('Meat', 1)] // Ingredientes da segunda receita
    ),
  ];
